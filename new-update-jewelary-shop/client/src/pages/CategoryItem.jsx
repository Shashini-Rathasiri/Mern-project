...
import "../styles/pageStyle/categoryitem.css";
...
const CategoryItem = () => {
  ...
  useEffect(() => {
    axios
      .get(`http://localhost:5000/api/products/find/${categoryItemId}`)
    ...
    <div>
      <div className="main_container">
        ...
        <div className="category_item_container">
          <div className="categoryitem_sm_image">
            <div
              className="sm_img1"
              style={{
          ...
          <div
            className="categoryitem_middle_image"
            style={{
              backgroundImage: product.img
                ? `url("${product.img[3]}")`
                : 'url("https://images.pexels.com/photos/2735970/pexels-photo-2735970.jpeg")',
          ...
          ></div>
          <div className="categoryitem_details">
            ...
            <div className="categoryitem_qty">
              <p>Qty</p>
